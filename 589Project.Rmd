...
```{r, fig.cap = "Quadrat counts of Red Fox occurences, left 5x5, right 10x10"}
...
```{r fig.cap="Ripley's K function with border correction assuming homogeneity"}
...
[Explanation why we use pair correlation function]
