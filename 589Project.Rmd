...
For smoothing estimate of the 4 covariates transformation rhohat() function was used which helped us to see the relationship between red fox occurrence and each covariate.
...
# Create table
table <- data.frame(Model = c("HFI", "HFI(Exp)", "Forest Cover", "Elevation", "Dist to Water" ), AIC = c(AIC(fitHFI), AIC(fitHFIexp), AIC(fit), AIC(fitElev), AIC(fitWater)))
